...
<!-- <img src="../images/team.png" align="center" width="100%"/> -->

<div class="institution" style="margin-top:24px;">
	<img src="../images/pnnl_logo.png" alt="Institution 1 logo"     style="height:auto; width:110px; float:left; margin-right:16px; position:relative; top:100px;"
    />
...
<div class="institution" style="margin-top:24px;">
    <img
    src="../images/lbl_logo.jpg"
    alt="Institution 2 logo"
    style="height:110px; width:110px; float:left; margin-right:16px; position:relative; top:22px;"
    />
	<div style="overflow:hidden;">
...
<div class="institution" style="margin-top:24px;">
	<img src="../images/uwm_logo.png" alt="Institution 3 logo"     style="height:auto; width:120px; float:left; margin-right:16px; position:relative; top:22px;"
    />
	<div style="overflow:hidden;">
...
<div class="institution" style="margin-top:24px;">
	<img src="../images/uw_logo.png" alt="Institution 4 logo" style="height:auto; width:120px; float:left; margin-right:16px; position:relative; top:30px;"
    />
	<div style="overflow:hidden;">
...
<div class="institution" style="margin-top:24px;">
	<img src="../images/lanl_logo.png" alt="Institution 5 logo" style="height:auto; width:120px; float:left; margin-right:16px; position:relative; top:28px;"
    />
	<div style="overflow:hidden;">
